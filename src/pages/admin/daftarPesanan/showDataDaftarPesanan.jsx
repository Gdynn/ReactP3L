...
import { GetAllDaftarPesanan } from "../../../api/apiDaftarPesanan";
import "../css/ShowDataUser.css";
import UpdateDataDaftarPesanan from "./updateDataDaftarPesanan";
import { useNavigate } from "react-router-dom";
import { STATUS } from "rsuite/esm/utils/constants";

const ShowDataDaftarPesanan = () => {
  const [isLoading, setIsLoading] = useState(false);
  const [daftarPemesananList, setDaftarPemesananList] = useState([]);
  ...
  const showDataDaftarPesanan = () => {
    ...
    GetAllDaftarPesanan()
      .then((response) => {
        setDaftarPemesananList(response);
      ...
      <div className="row d-flex">
        <div className="col px-0 mx-0">
          <div className="container">
            ...
            >
              Show Data Pemesanan Yang Perlu Dikonfirmasi
            </h1>
            <div className="row">
              <div className="col-8">
                <div className="row">
              ...
              <div className="table-responsive mt-3">
                <table className="table table-hover">
                  ...
                  <tbody>
                    {daftarPemesananList.map((pemesanan, index) => (
                      <tr key={pemesanan.id}>
                        ...
                        <td>
                          {pemesanan.BUKTI_BAYAR && (
                            <img
                              src={`data:image/jpeg;base64,${pemesanan.BUKTI_BAYAR}`}
                              alt="Bukti Bayar"
                              style={{ width: "100px" }}
                            />
                          )}
                        ...
                        <td>
                          <UpdateDataDaftarPesanan
                            pemesanan={pemesanan}
                            onClose={ShowDataDaftarPesanan}
                          />
                        </td>
...
export default ShowDataDaftarPesanan;
